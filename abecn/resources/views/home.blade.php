<x-layout>
    <main>
        <section class="w-full bg-cover bg-center bg-home mb-9" style="height:16rem;">
            <div class="flex items-center text-center justify-center align-middle h-full w-full bg-gray-900 bg-opacity-50 background-image: {{ asset('img/skyscrapers.jpg') }};"> 
                <div class="banner-text inner-container">
                    ...
                    <a href="#" class="mt-4 px-4 py-2 bg-blue-600 text-white text-sm uppercase font-medium rounded focus:outline-none">BECOME A MEMBER</a>
                </div>
            </div>
        </section>
        <section class="welcome justify-between inner-container">
            ...
            <div class="welcome-img">
                <img src=".../public/img/audience.jpg" alt="Silhoutte of presentation">
            </div>
        </section>
